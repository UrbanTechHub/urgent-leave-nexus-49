  ...
  return (
    <div className="bg-gray-50 py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12">Emergency Leave Application Process</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600">
                Complete the multi-step application form with all required information including military personnel details and emergency information.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600">
                Our emergency response team reviews applications within 24-48 hours based on urgency and mission requirements.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Approval & Coordination</h3>
              <p className="text-gray-600">
                Upon approval, we coordinate with military command for leave authorization and travel arrangements as needed.
              </p>
            </CardContent>
          </Card>
        </div>
